...
The Sidecar reads the wire protocol, so it needs the connection in the clear. Terminate TLS in front of it — see [Running the Sidecar](/install/cli#running-the-sidecar) for the Envoy shapes.
