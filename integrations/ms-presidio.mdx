...
Microsoft Presidio detects, classifies, and masks sensitive data across your infrastructure sessions. Hoop enforces guardrails and protects PII across all connected resources.
...
- Use Microsoft Presidio’s analyzers and recognizers to detect sensitive entities
...
<Steps>
  <Step title="Install">
    Install Microsoft Presidio using Docker or Kubernetes.
