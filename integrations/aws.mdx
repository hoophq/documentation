...
<Note>
    ...
    For detailed configuration instructions, please refer to the [Vault secrets manager documentation](https://hoop.dev/docs/learn/secrets-manager#hashicorp-vault-provider).
</Note>