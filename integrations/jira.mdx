...
Hoop.dev's Jira integration turns infrastructure access requests into automated Jira workflows, streamlining change management and security processes.
...
- **Access Control:** Automate approvals and access requests through Jira workflows

## Configuration

Enable the Jira integration in the **Integrations** section of your Hoop.dev instance. For step-by-step setup and advanced options, see [Advanced Configuration](#advanced-configuration).
...
<Info>Jira Assets requires an Enterprise or Premium account.</Info>
