---
title: "Slack"
description: "Manage access requests directly from your Slack workspace."
---
...
You can also configure the integration via CLI:
...
Go to the Slack plugin page via **Manage plugins > Slack**. Click **Settings** and add the channels (comma-separated) to receive access request notifications for that connection.
