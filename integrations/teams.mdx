---
title: "Teams"
description: "Send Microsoft Teams notifications when access request events occur."
---
...
Define which connections trigger events using the plugin configuration. Update or add a connection to enable this plugin.
...
Executing a command via the Web App or CLI creates an access request and sends an alert to the configured Teams channel.
