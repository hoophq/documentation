---
title: "Ruby on Rails"
description: "Web application framework for Ruby development and Rails console access"
...
<ConnectionTemplate config={{
  ...
  "gatewayInformation": {
    ...
    "credentials": {
      "authType": "Application-level authentication",
      "config": "Rails application access with environment variables"
    }
  }
}} />
