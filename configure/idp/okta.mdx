...
<Steps titleSize="h3">
  ...
  <Info>
  If the above instructions are not applicable to your Okta setup, configure it by adding a group claim to the organization's authorization server. Refer to [this documentation](https://developer.okta.com).
  </Info>
  </Step>
</Steps>
