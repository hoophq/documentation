...
<Steps>
  <Step title="Reconfigure IDP Configuration">
...
<Warning>
  ...
  The name of the admin group depends either your propagating the groups as object ids or as group names (see below).
</Warning>
