...
<AccordionGroup>
  <Accordion title="values.yaml (minimal)">
    ...
    Make sure to create a strong secret key for `JWT_SECRET_KEY` configuration, the command below generate a strong key:
