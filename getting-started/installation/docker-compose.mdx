...
(...)
hoop-agent-1    | (...) connected with success to <machine-host>:443
```
...
- This warning could appear more than once, because the app will redirect you to `https://auth.<machine-host>`
