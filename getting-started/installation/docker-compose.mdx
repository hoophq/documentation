...
<Steps>
  ...
  <Step title="Set the .env file">
    ...
    <Note>The .env file must be at the same level as the docker-compose.yml file</Note>
    ...
    <Tabs>
      ...
      <Tab title="Custom Identity Provider">
        ...
        <Note>Make sure to allow your Identity Provider to redirect to the Hoop API and GRPC services URLs</Note>
      </Tab>
    </Tabs>
...
### Troubleshooting for Production Environments with API_URL
