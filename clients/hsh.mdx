...
<Tabs>
  <Tab title="MacOS">
    ...
    <Note>
      Homebrew installs the `hsh` CLI only. If you also want the [Hoop Tunnel](/clients/hsh-tunnel) daemon, install from the release archive instead — see the [tunnel installation steps](/clients/hsh-tunnel#installation).
    </Note>
  </Tab>
  <Tab title="Linux">
