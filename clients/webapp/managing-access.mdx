...
**Administrators control connection access through user groups and per-connection settings.**
...
### Group Management
Groups are the primary access control unit:

<Steps>
  <Step title="Create Groups">
    Create groups that represent teams or access levels (e.g., `engineering`, `sales`, `admin`).
  </Step>
...
Configure access controls in the connection's Configuration tab:
