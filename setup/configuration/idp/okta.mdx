...
<Steps titleSize="h3">
  ...
  <Step title="Configure Hoop Gateway">
    ...
    For detailed instructions, please consult the `IDP_URI` configuration section in our [OAuth2/OIDC Authentication Documentation](/setup/configuration/env-vars)
  </Step>
