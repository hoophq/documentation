...
description: "All fields available for data masking in Hoop."
---

## Microsoft Presidio

For the latest supported fields, see the [Microsoft Presidio documentation](https://microsoft.github.io/presidio/supported_entities/).

Microsoft Presidio also supports custom fields. See [Adding a Custom PII Entity](https://microsoft.github.io/presidio/supported_entities/#adding-a-custom-pii-entity) for details.
