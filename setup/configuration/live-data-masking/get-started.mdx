...
<Steps>
  <Step title="Set up">
    ...
    | Environment variable key | Value                     | Required |
    | ------------------------ | ------------------------- | -------- |
    | `DLP_PROVIDER`           | alcatraz                  | Yes      |
    | `DLP_MODE`               | `best-effort` or `strict` | No, defaults to `best-effort` |
...
<CardGroup cols={2}>
  <Card title="Alcatraz deployment" icon="server" href="/setup/deployment/alcatraz">
    Provisioning the model, sizing, verification and troubleshooting.
  </Card>
  <Card title="Container images" icon="box" href="/setup/deployment/container-images#the-alcatraz-tags">
