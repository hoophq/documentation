...
description: "Configure per-command approval workflows that block execution until an authorized reviewer approves"
---
...
<Steps>
  ...
  <Step title="Configure Approvers">
    ...
    - Group members will receive approval notifications
  </Step>
  <Step title="Save">
...
Admin users auto-approve their own requests. To test the full workflow, use a non-admin account.
...
- **Guardrails:** Automatically block dangerous commands
...
Approved queries still show masked results:
