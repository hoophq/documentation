...
<Note>
For AI-powered data masking that automatically detects PII, see [AI Data Masking](/learn/features/ai-data-masking) instead.
</Note>
...
<Note>
Require Approval uses the same workflow as [One-Time Access Requests](/learn/features/access-requests/one-time).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Data Masking" icon="mask" href="/setup/configuration/ai-data-masking/get-started">
    Configure automatic PII detection and masking
  </Card>
  <Card title="One-Time Access Requests" icon="clock" href="/setup/configuration/access-requests/one-time-configuration">
