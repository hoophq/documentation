...
<CardGroup cols={2}>
  ...
  <Card title="One-Time Access Requests" icon="shield-check" href="/setup/configuration/access-requests/one-time-configuration">
    Configure command approval workflows
  </Card>
</CardGroup>