...
| Allowed | One-Time enabled | Each command needs approval |
...
Connection: contractor-db
  ...
  (Limited database, AI Data Masking enabled)
```
...
1. **Access Requests:** Is JIT or One-Time approval required?
...
<CardGroup cols={2}>
  ...
  <Card title="Access Requests" icon="clock" href="/learn/features/access-requests/overview">
