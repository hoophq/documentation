...
| `identity_header` | Names an HTTP header carrying the authenticated subject. Refused on `ssh`, where the identity comes from the certificate the lane verified itself. |
