...
Add `GIT_HOOK_CONFIG_TTL` when configuring the runbooks plugin. This activates hook support and sets how long (in seconds) the configuration is cached between git fetches.
