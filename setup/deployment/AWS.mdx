...
1. **Admin permissions**: required to deploy the stack and create resources. We recommend an isolated AWS account to avoid hitting service limits.
2. **Dedicated AWS account**: reduces the risk of configuration errors and keeps management simple.

## Setup

Click a region-specific button below and follow the AWS CloudFormation console:
