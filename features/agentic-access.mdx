...
<Steps>
  <Step title="trigger narrows what is classified">
    Only statements naming these operations, tables or resources are sent. Everything else allows for free. An **empty trigger is a startup error** on an ungated lane — the failure mode of the opposite default is an invoice. Under `opa.gate: true`, an empty trigger is how you say Rego decides what is worth classifying.
  </Step>
