...
The chart renders a Gateway and an HTTPRoute rather than an Ingress. This requires the Gateway API CRDs in your cluster — `istioctl install` for Istio, or the [upstream guides](https://gateway-api.sigs.k8s.io/guides/) for anything else.
