...
<Frame>
  <img
    ...
    src="/images/learn/session-recording_light.png"
  />
  <img
    className="hidden dark:block"
    src="/images/learn/session-recording_dark.png"
  />
</Frame>

You can audit tracks every action made with hoop. It provides video recordings of sessions and logging.
