...
AI Data Masking automatically detects and redacts sensitive data in your query results. Unlike traditional DLP solutions that require complex rule configuration, Hoop's AI-powered masking works out of the box:
...
See [AI Data Masking Configuration](/setup/configuration/ai-data-masking/get-started) for detailed setup instructions.
...
AI Data Masking detects these sensitive data types by default:
...
Add or remove fields from detection. See [Supported Fields](/setup/configuration/ai-data-masking/fields) for the complete list.
...
- Enable AI Data Masking on production connections
...
**Check:**
1. AI Data Masking is enabled on the connection
2. DLP provider is running and accessible
3. Gateway environment variables are set correctly
4. The data type is in the [supported fields list](/setup/configuration/ai-data-masking/fields)
...
AI Data Masking adds latency to query results:
...
AI Data Masking helps meet requirements for:
...
<Note>
AI Data Masking is one layer of a defense-in-depth strategy. Combine with [Access Control](/learn/features/access-control) and [Guardrails](/learn/features/guardrails) for comprehensive protection.
</Note>
...
<CardGroup cols={2}>
  <Card title="Configuration Guide" icon="gear" href="/setup/configuration/ai-data-masking/get-started">
    Set up Microsoft Presidio or GCP DLP
  </Card>
  <Card title="Supported Fields" icon="list" href="/setup/configuration/ai-data-masking/fields">
