...
**Live Data Masking** detects and redacts sensitive data in query results automatically. Unlike traditional DLP tools, it requires no rule configuration:
...
<Steps>
  ...
  <Step title="Results Analyzed">
    Hoop scans the query results for sensitive data patterns
  </Step>
...
If legitimate data is masked incorrectly:
...
Live Data Masking adds latency proportional to result size:
...
Live Data Masking supports compliance with:
