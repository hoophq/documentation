...
<Frame>
  <img src="/images/learn/features/secrets-manager.png" />
</Frame>
...
For detailed configuration instructions and setup guides, see our [Secrets Manager Configuration](/setup/configuration/secrets-manager-configuration) documentation.