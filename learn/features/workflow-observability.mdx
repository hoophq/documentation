...
description: "See exactly what scripts, CI/CD jobs, and AI agents did in Hoop, attributed to named identities and grouped by workflow run"
---
...
Workflow Observability lets you see exactly what any headless caller (script, CI/CD job, scheduled batch, or AI agent) did in Hoop, with the same identity, audit, and policy story as an interactive user. You can:
