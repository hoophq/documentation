...
<Steps>
  ...
  <Step title="Configure review groups and connection policies">
    Access [users management page](https://use.hoop.dev/organization/users) to set up the necessary review groups and define the policies that will govern on your connections.
  </Step>
